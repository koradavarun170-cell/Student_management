pipeline {
    ...
    tools {
        maven 'Maven3'   // Name must match a Maven install configured in Manage Jenkins > Tools
        jdk 'JDK17'      // Name must match a JDK install configured in Manage Jenkins > Tools
    }
